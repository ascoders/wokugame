...
exports.default = dynamic_react_1.Connect((props = new typings.Props()) => {
    return (React.createElement(menu_tree_style_1.Container, { theme: { height: props.menuStore.height }, name: "woku-menu-tree" },
        typeof props.title === 'string'
            ? props.title
            : props.title(),
        React.createElement(menu_tree_style_1.TreeItem, { name: "woku-menu-subtree", theme: { top: props.menuStore.height } }, props.children)));
});
