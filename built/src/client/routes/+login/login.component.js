...
exports.default = dynamic_react_1.Connect((props = new typings.Props()) => {
    const handleSubmit = () => __awaiter(this, void 0, void 0, function* () {
        const result = yield props.UserAction.loginWithNicknamePassword(props.LoginPageStore.nickname, props.LoginPageStore.password);
        if (result) {
    ...
    return (React.createElement(register_style_1.Container, null,
        React.createElement(register_style_1.CenterContainer, null,
            React.createElement(input_1.default, { label: "昵称", value: props.LoginPageStore.nickname, onChange: handleNicknameChange }),
            React.createElement(register_style_1.PasswordContainer, null,
                React.createElement(input_1.default, { label: "密码", value: props.LoginPageStore.password, onChange: handlePasswordChange })),
